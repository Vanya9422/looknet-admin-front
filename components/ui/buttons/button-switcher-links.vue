<template lang="pug">
  .button-switcher.button-switcher__links(:class="Mods")
    .button-switcher__list
      .button-switcher__item(
        v-for="(item, i) in items"
        :key="i"
      )
        NuxtLink.button-switcher__btn(:to="item.link")
...
<style lang="scss">
.button-switcher__links .button-switcher__btn.nuxt-link-exact-active{
  color: #fff;
  background: $blue;
