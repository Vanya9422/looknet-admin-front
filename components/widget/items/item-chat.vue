    ...
    @click="$emit('change')"
      ...
      span.item-chat__info
        ...
        span.item-chat__body
          ...
          //- span.item-chat__time(v-if="small == flase") {{time}}
</template>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapMutations({
        SET_MESSAGES_SEEN: 'support_chat/SET_MESSAGES_SEEN',
        SET_MESSAGES_SEEN_ON_SIDEBAR: 'support_chat/SET_MESSAGES_SEEN_ON_SIDEBAR',
      }),
    },
    created() {
      if (this.conversation_id && this.$auth.loggedIn) {
