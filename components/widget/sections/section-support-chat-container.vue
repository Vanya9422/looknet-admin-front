  ...
  section.support-chat
    .support-chat__top
      .support-chat__head.flex.flex_vertical.flex_justify
        ...
        button-switcher-links.support-chat__head-switcher(:items="switchers" name="switchers2" blue)
    slot(name="filter")
    ...
    .support-chat__body
      slot(name="table")
        part-chat-table(:rows="rows" )
        part-chat-sidebar.support-chat__sidebar(:list="list")
    .support-chat__bottom
      button-switcher-links.support-chat__switcher(:items="switchers" name="switchers2" blue)
    slot(name="footer")
</template>
