    ...
    .correct-text__section
      .correct-text__row.flex
        ...
        .correct-text__column.correct-text__column_right
          ...
          .correct-text__field
            .correct-text__field-head.flex.flex_vertical.flex_justify
              .correct-text__field-title.h4 Have any Errors
            form-input.correct-text__input(
              v-model="content.anyErrors"
              @input="$v.content.anyErrors.$touch()"
              :error="$v.content.anyErrors.$error"
            )
    .correct-text__section
      .correct-text__row.flex
        .correct-text__column.correct-text__column_left
...
export default {
  ...
  validations: {
    content: {
      ...
      anyErrors: {required, minLength: minLength(2)},
      name:{
